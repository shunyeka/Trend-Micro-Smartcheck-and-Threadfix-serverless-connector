...
def lambda_handler(event, context):
    ...
    dssc_results = get_analysis(DSSC_URL,DSSC_SMARTCHECK_USER,DSSC_SMARTCHECK_PASSWORD,DSSC_MIN_SEVERITY,scan["name"],DSSC_SHOW_FIXED,DSSC_SHOW_OVERRIDDEN,DSSC_INSECURE_SKIP_TLS_VERIFY)
    ...
    response = requests.get('https://threadfix.arisglobal.com/threadfix/rest/latest/applications/18/scans',headers=headers)
